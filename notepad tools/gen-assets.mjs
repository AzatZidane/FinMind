...
// Источник: AppIcon1024.png (ищем сначала в appiconset, затем в корне репо)
import fs from "fs";
...
// Автодетект структуры: FinMind/Assets.xcassets или FinMind/FinMind/Assets.xcassets
const candidates = [
...
// Источник 1024: из appiconset, иначе из корня
...
(async () => {
  ...
  // LaunchLogo (2x/3x) и свой Contents.json
